    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="./areaProcess.php" class="ms-1 text-sm font-medium text-gray-700  md:ms-2 dark:text-gray-400 dark:hover:text-white">Area Result</a>
            </div>
        </li>
...
$sql = "INSERT INTO area_results (width,breadth,result) VALUES ('$width','$breadth','$area')";
